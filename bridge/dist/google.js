...
function saveTokens(t) { fs.writeFileSync(TOK_PATH, JSON.stringify(t, null, 2)); }
function haveTokens() { return fs.existsSync(TOK_PATH); }
function loadTokens() { return JSON.parse(fs.readFileSync(TOK_PATH, 'utf8')); }
...
export async function createHold(calendarId, title, whenISO, durationMin) {
    ensureAuth();
